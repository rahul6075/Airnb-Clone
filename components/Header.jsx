...
function Header({placeholder}) {
  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md  px-5 py-2 md:px-10 ">
      <motion.div whileHover={{ scale: 1.05, rotate: 0.1 }} onClick={() => router.push('/')} className="relative flex items-center h-10 cursor-pointer my-auto">
        <Image
      ...
      <div className="flex items-center space-x-4 justify-end text-gray-500">
        <p className="hidden md:inline">Became a host</p>
